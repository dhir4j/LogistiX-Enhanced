...
const testimonials = [
  { name: "Anjali Mehta", role: "E-commerce Store Owner", quote: "HK SPEED COURIERS PRIVATE LIMITED has transformed our shipping process. Their reliability and professionalism are unmatched. Our customers are happier than ever with the speedy deliveries." },
  { name: "Rahul Verma", role: "Corporate Client", quote: "We trust HK SPEED COURIERS PRIVATE LIMITED with all our important documents and parcels. Their secure and timely service gives us complete peace of mind. Highly recommended for any business." },
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="bg-secondary py-14 sm:py-20 border-t">
          ...
          <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {howItWorksSteps.map((step, index) => (
              <div key={index} className="text-left p-6 border bg-secondary rounded-lg shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-2 animate-fade-in-up" style={{ animationDelay: `${index * 150}ms` }}>
                ...
                <p className="text-muted-foreground mt-2 text-left">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-10 gap-12 items-center">
              <div className="md:col-span-6 animate-slide-in-from-left">
                  ...
                  <p className="mt-4 text-muted-foreground text-lg">
                      HK SPEED COURIERS PRIVATE LIMITED is dedicated to providing superior logistics and courier services. We are founded on the principles of reliability, efficiency, and unwavering customer support, ensuring your business and personal shipping needs are met with the highest standards of excellence.
                  </p>
