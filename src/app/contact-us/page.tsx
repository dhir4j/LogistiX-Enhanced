      ...
      <div className="container">
        <Card className="max-w-4xl mx-auto shadow-lg border">
          <CardHeader className="text-center pb-8">
            ...
            <CardDescription className="text-lg">We welcome your inquiries. Please use the information below to contact us.</CardDescription>
          </CardHeader>
          <CardContent className="grid md:grid-cols-3 gap-8 text-center mt-6">
            <div className="flex flex-col items-center space-y-3 p-6 rounded-md border bg-background">
              <div className="flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 text-primary">
                <MapPin className="h-8 w-8" />
              </div>
              <h3 className="font-semibold text-lg pt-2">Corporate Address</h3>
            ...
            <div className="flex flex-col items-center space-y-3 p-6 rounded-md border bg-background">
              ...
              <h3 className="font-semibold text-lg pt-2">Phone</h3>
              <p className="text-muted-foreground">
            ...
            <div className="flex flex-col items-center space-y-3 p-6 rounded-md border bg-background">
              ...
              <h3 className="font-semibold text-lg pt-2">Email</h3>
              <p className="text-muted-foreground">
